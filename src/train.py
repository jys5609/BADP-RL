...
def main():
    ...
    # args.decay_every = 1
    # args.decay_rate = 5.0
    # args.domain = 'object_division'
    # args.dropout = 0.1
    # args.model_type = 'rnn_model'
    # args.init_range = 0.2
    # args.lr = 0.001
    # args.max_epoch = 35  # 30
    # args.min_lr = 1e-07
    # args.momentum = 0.1
    # args.nembed_ctx = 64
    # args.nembed_word = 256
    # args.nhid_attn = 64
    # args.nhid_lang = 128
    # args.sel = 128
    # args.sel_weight = 0.6
    # args.unk_threshold = 20
    # args.sep_sel = True
    # # args.model_file = 'rnn_model_%d.th' % selfplay_round
    # # args.data = 'data/negotiate_selfplay_%d' % selfplay_round
    # args.model_file = 'rnn_model.th'
    # args.data = 'data/negotiate'
    # ##
    ...
    if selfplay_round == 0 or True:
        print('newly create')
        model = model_ty(corpus.word_dict, corpus.item_dict_old, corpus.context_dict, corpus.count_dict, args)
    else:
        print('load existing model and fine tune')
        # prev round's model file
        prev_model_file = 'rnn_model_%d.th' % (selfplay_round - 1)
        model = utils.load_model(prev_model_file)
    if args.cuda:
        model.cuda()
